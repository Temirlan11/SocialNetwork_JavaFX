...
<%--    <script src="https://cdn.tiny.cloud/1/kh7qaklo1eivb61hxnyn6tvehof7jnn0ge02x5lr852ymhbp/tinymce/5/tinymce.min.js" referrerpolicy="origin"></script>--%>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <blockquote class="blockquote mb-0">
                                    ...
                                    <form action="/moredetails" method="get">
                                        <button type="submit" name="moredetails_id" class="btn btn-outline-primary mt-3" value="<%=post.getId()%>">More</button>
                                    </form>
